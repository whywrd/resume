...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \resumeitem{Teachers assistant for CS110b (Programming Fundamentals in C++)'}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \resumeitem{Core business units depend on SalesForce to coordinate teams. Examples of projects that have improved this experience include:}
        \vspace{0ex}
        \begin{itemize}
