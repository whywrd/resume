...
\begin{itemize}
    ...
    \end{itemize}
    \item \resumesubheading{clickonly.us}{}
    \begin{itemize}
        \resumeitem{Click tracking and analytics portion of a larger project that never saw the light of day}
        \resumeitem{Stack: Linux, Nginx, Python}
        \resumeitem{Other technologies: Docker, Flask, LetsEncrypt, Postgres, and RabbitMQ}
        \resumeitem{Interesting design decision: A queue of previously visited pages is the only info stored in cookies. The goal was to store a minimal amount of non-identifiable data that could yeild maximum insight.}
    \end{itemize}
\end{itemize}

\resumeheading{Skills}
\begin{itemize}
    \resumeitem{Python (3), Git, Bash, SQL, Linux, QA, technical customer support}
\end{itemize}
